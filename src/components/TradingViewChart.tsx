...
export default function TradingViewChart({
  ...
  const containerId = useMemo(
    () => `tv_${symbol.replace(/[^a-zA-Z0-9]/g, "_")}_${Math.random().toString(36).slice(2, 7)}`,
    [symbol]
  );
  ...
  return (
    <div className="glass-card p-6 rounded-lg animate-fade-in flex flex-col" style={{ minHeight: 500 }}>
      {title ? (
