...
const HistoricalData = () => {
  ...
  const exchangeRates: Record<string, Record<string, number>> = {
    ...
    THB: { USD: 0.027, JPY: 4.18, CNY: 0.267, EUR: 0.025, GBP: 0.021 },
    JPY: { USD: 0.0067, THB: 0.24, CNY: 0.048, EUR: 0.0062, GBP: 0.0053 },
    CNY: { USD: 0.138, THB: 3.75, JPY: 20.65, EUR: 0.127, GBP: 0.109 },
    EUR: { USD: 1.09, THB: 40.15, JPY: 162.50, CNY: 7.88, GBP: 0.86 },
    GBP: { USD: 1.27, THB: 46.75, JPY: 189.20, CNY: 9.18, EUR: 1.16 },
  };

  const currencies = ['USD', 'THB', 'JPY', 'CNY', 'EUR', 'GBP'];

  const convertedAmount = amount && !isNaN(parseFloat(amount))
    ? (parseFloat(amount) * (exchangeRates[fromCurrency]?.[toCurrency] || 1)).toFixed(2)
    : '0.00';
          ...
          <div className="grid gap-4">
            ...
            <div className="grid grid-cols-[1fr_auto_1fr] gap-4 items-end">
              ...
              <button
                ...
                className="mb-2 p-2 rounded-lg hover:bg-accent transition-colors"
